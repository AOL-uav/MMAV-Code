...
static const int SWEEP_FOLD_MS    = 1067;  // ~80deg fold   (scaled from 800ms @60deg)
static const int SWEEP_UNFOLD_MS  = 1693;  // ~80deg unfold (scaled from 1270ms @60deg)
...
// FOLDED: ~30deg incidence in storage (interpolated between flat and old 90deg values).
