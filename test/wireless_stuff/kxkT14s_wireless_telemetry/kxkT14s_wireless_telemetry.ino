...
static const float SD_LOG_HZ = 50.0f;  // testing rate (was 20). Effective rate is
                                       // capped by the control loop (~36 Hz until the
                                       // ESEKF is optimized). Logger thread drops rows
                                       // rather than delaying control if SD lags —
