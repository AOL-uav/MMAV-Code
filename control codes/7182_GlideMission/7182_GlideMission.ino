...
struct ControlRecord {
  ...
  uint8_t  navWindHoldFlag;   // 1 while wind guard is holding wings level
...
static bool  navWindHold   = false; // wind guard active: holding wings level
...
void setup() {
  ...
  serialMutex.lock();
  Serial.println(F("[Core0] 7182_GlideMission boot (wind-guard variant)"));
